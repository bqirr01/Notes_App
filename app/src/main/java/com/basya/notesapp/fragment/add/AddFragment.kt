package com.basya.notesapp.fragment.add
...
import com.basya.notesapp.databinding.FragmentAddBinding
...
class AddFragment : Fragment() {
    ...
    private fun insertDataToDatabase(){
        ...
        if (validation) {
            ...
            Toast.makeText(requireContext(), "please fill in the blank column :)", Toast.LENGTH_SHORT).show()
        }
    }
}